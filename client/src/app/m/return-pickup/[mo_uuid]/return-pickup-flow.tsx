...
function FitBadge({
  ...
  // Uncertain-tone chip when the backend couldn't verify the fit
  // (missing packaging dims OR cell dims) — a distracted operator
  // shouldn't see a green "100% free" tick for a legacy lot.
  if (fit.known === false) {
    return (
      <span
