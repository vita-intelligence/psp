...
const PHASE_LABEL: Record<OrderWizardPhaseKey, string> = {
  ...
  awaiting_shortfall_resolution: "Shortfall to resolve",
...
const PHASE_ACCENT: Record<OrderWizardPhaseKey, string> = {
  ...
  awaiting_shortfall_resolution: "bg-destructive/70",
  ready_to_dispatch: "bg-sky-500/80 dark:bg-sky-400/80",
  in_bailee_custody: "bg-violet-500/80 dark:bg-violet-400/80",
...
> = {
  ...
  awaiting_shortfall_resolution: "destructive",
  ready_to_dispatch: "sky",
  in_bailee_custody: "muted",
