defmodule BackendWeb.Payloads do
  ...
  def workstation(%Backend.Production.Workstation{} = w) do
    %{
      ...
      maintenance_periodicity: w.maintenance_periodicity,
      maintenance_periodicity_interval: w.maintenance_periodicity_interval,
      last_maintenance_at: w.last_maintenance_at,
      next_maintenance_due_at: w.next_maintenance_due_at,
      created_by: actor(w, :created_by),
      updated_by: actor(w, :updated_by),
      inserted_at: w.inserted_at,
      updated_at: w.updated_at
  ...
  def equipment(%Backend.Equipment.Equipment{} = e) do
    %{
      ...
      cleaning_periodicity: e.cleaning_periodicity,
      cleaning_periodicity_interval: e.cleaning_periodicity_interval,
      last_cleaning_at: e.last_cleaning_at,
      next_cleaning_due_at: e.next_cleaning_due_at,
